  ...
  return (
    <div className="relative w-52" ref={ref}>
      <button
        ...
        className="flex justify-between items-center w-full bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        {selectedLabel}
        <ChevronDown size={18} />
      </button>
