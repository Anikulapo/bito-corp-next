...
export default function LoginPage() {
  ...
  const inputFocus = isDarkMode ? 'focus:border-indigo-400' : 'focus:border-indigo-500';
        ...
        <div className={`${cardBg} rounded-2xl shadow-xl p-8 transition-colors duration-200`}>
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${textSecondary} w-5 h-5`} />
                <input
                  type="email"
                  name="email"
            ...
            {isSignUp && (
              <>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Building2 className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${textSecondary} w-5 h-5`} />
                    <input
                      type="text"
                      name="businessName"
                ...
                <div>
                  ...
                  <div className="relative">
                    <MapPin className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${textSecondary} w-5 h-5`} />
                    <input
                      type="text"
                      name="location"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Phone className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${textSecondary} w-5 h-5`} />
                    <input
                      type="tel"
                      name="phoneNumber"
            ...
            <div>
              ...
              <div className="relative">
                <Lock className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${textSecondary} w-5 h-5`} />
                <input
                  type="password"
                  name="password"
            ...
            {!isSignUp && (
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  />
                  <span className={`ml-2 text-sm ${textColor}`}>Remember me</span>
                </label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-2 ${cardBg} ${textSecondary}`}>Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className={`flex items-center justify-center px-4 py-3 ${inputBg} ${inputBorder} border rounded-lg hover:bg-gray-100 ${isDarkMode ? 'hover:bg-gray-700' : ''} transition-colors`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-center px-4 py-3 ${inputBg} ${inputBorder} border rounded-lg hover:bg-gray-100 ${isDarkMode ? 'hover:bg-gray-700' : ''} transition-colors`}
            >
              <svg className="w-5 h-5 mr-2" fill={isDarkMode ? '#fff' : '#000'} viewBox="0 0 24 24">
